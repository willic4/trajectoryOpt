...
Aeq=[];
beq=[];
lb = [1;    ones(gridN * 1, 1) * -Inf; ones(gridN * 1, 1) * r_earth; 0 ; ones(gridN-1, 1) * -Inf; 0 ; ones(gridN-1, 1) * -Inf; ones(gridN, 1) * -maxacc; ones(gridN, 1) * -maxacc];
ub = [Inf;  ones(gridN * 1, 1) * Inf ; ones(gridN * 1, 1) * finalr; 50; ones(gridN-1, 1) *  Inf; 50; ones(gridN-1, 1) *  Inf; ones(gridN, 1) *  maxacc; ones(gridN, 1) *  maxacc];
