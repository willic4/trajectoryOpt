...
filename = 'minaccel_flatearth.gif'; % specify file name
%% trajectory options
...
Aeq=[];
beq=[];
lb = [1;    ones(gridN * 1, 1) * 0; ones(gridN * 1, 1) * r_earth; 0 ; ones(gridN-1, 1) * -Inf; 0 ; ones(gridN-1, 1) * -Inf; ones(2*gridN, 1) * -maxacc];
