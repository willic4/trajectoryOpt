...
outFolderName = "C:\Users\billy\Documents\GitHub\trajectoryOpt\Sandbox\Presentationworthy\minaccelandtime_roundearth_replay_xy";   % Your destination folder
mkdir(outFolderName)
%% trajectory options
...
global gridN initialstate finalstate finalr mu r_earth
    ...
    for i = 1 : length(xs) - 1
        ...
        xdot_i = [xds(i); yds(i);xcmd(i)+grav_i(1);ycmd(i)+grav_i(2)];
        ...
        xdot_n = [xds(i+1); yds(i+1);xcmd(i+1)+grav_n(1);ycmd(i)+grav_n(1)];
